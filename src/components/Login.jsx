      ...
      <div className={styles.div}>
         <form className={styles.form} onSubmit={((e) => handleSubmit(e))}>
            ...
            <div className={styles.field}>
               ...
               <input autoComplete="on" placeholder="Username" class={styles.inputField} type="text" onChange={(e) => handleInputChange(e)} />
            ...
            <div className={styles.field}>
               ...
               <input placeholder="Password" class={styles.inputField} type="password" onChange={(e) => handleInputChange(e)} />
            </div>
